...
def create_main_window():
    ...
    def create_about_window():
        ...
        try:
            pizza_img = PhotoImage(file="pizza_image.png")  # Replace with actual image if available
    ...
    tk.Label(root, text="Choose Pizza Size:").pack()
    for size in ["Small", "Medium", "Large"]:
        tk.Radiobutton(root, text=size, variable=pizza_size, value=size).pack()

    tk.Label(root, text="Choose Crust Type:").pack()
